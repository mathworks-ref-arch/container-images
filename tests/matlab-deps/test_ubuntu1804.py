"""Test class for matlab-deps:ubuntu18.04 Docker images."""
...
class TestUbuntu1804(test_ubuntu.TestUbuntu):
    def setUp(self):
        """Skip this test class unless the platform is 'ubuntu18.04'"""
